        ...
        {tasks.map((task) => (
          ...
          >
            <div className="task-icon">
              <img src={aegisosIcon} alt="Task Icon" />
            </div>
